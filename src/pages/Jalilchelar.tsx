    ...
    <div className="min-h-screen bg-white text-[#1a1a1a]" style={{ fontFamily: "'Golos Text', sans-serif" }}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-[#e5e5e5]">
        <div className="max-w-[1200px] mx-auto px-8 md:px-16 lg:px-24 flex items-center justify-between h-16">
          <Link to="/moabit" className="flex items-center gap-2 font-body text-[13px] tracking-[0.1em] text-[#555] hover:text-[#1a1a1a] transition-colors">
            <Icon name="ChevronLeft" size={15} />
            <span className="hidden sm:inline">Моабит дәфтәрләре</span>
          </Link>
          <div className="flex items-center gap-5">
            <span className="font-body text-[12px] tracking-[0.15em] uppercase text-[#aaa]">06 / 07</span>
            <Link to="/bugen" className="flex items-center gap-1 font-body text-[12px] text-[#aaa] hover:text-[#1a1a1a] transition-colors">
              <span className="hidden sm:inline">Бүгенге көн</span>
      ...
      <main className="px-8 md:px-16 lg:px-24 pb-24">
        <div className="w-full">
          ...
          <div className="border-t border-[#e5e5e5] mt-10 pt-10 flex items-center justify-between">
            ...
            <Link to="/bugen" className="flex items-center gap-2 font-body text-[13px] text-[#888] hover:text-[#1a1a1a] transition-colors">
              Бүгенге көн
