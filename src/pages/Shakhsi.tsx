      ...
      <main className="px-8 md:px-16 lg:px-24 pb-24">
        <div className="w-full">
          ...
          <div className="mb-10 w-full">
            ...
            <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-4 text-justify">
              1936 елның җәендә Муса икътисад техникумын тәмамлаган Әминә Сәйфуллинага өйләнгәнче, аның ике никахы һәм ике баласы — Альберт белән Люция була. 1937 елның апрелендә Муса Җәлилнең кече кызы Чулпан туа.
            </p>
            <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-4 text-justify">
              Муса Җәлил иҗади мохиттә иркен йөзде. Ул заманының иң күренекле шагыйрьләре, композиторлары, театр белгечләре белән тыгыз аралашты. Дусларының даирәсе киң иде — аларның арасында Казанның, Мәскәүнең, Ленинградның сәнгать кешеләре бар иде.
            </p>
            <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-4 text-justify">
              «Октябрь баласы» журналы тирәсендә тупланган яшь каләмдәшләр белән уртаклашу, иҗади фикер алышу аны рухландырды. Бу чор аның шигъри осталыгының формалашуына зур этәргеч булды. Шагыйрь матбугат дөньясында да актив катнашты — журналистлар, газета редакторлары, башкорт шагыйрьләре белән якын мөнәсәбәттә булды, мәдәни күперләр корды.
            </p>
            <div className="clear-both" />
          </div>
