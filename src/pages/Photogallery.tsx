...
const photos = [
  ...
  { src: "https://cdn.poehali.dev/files/253dd7db-d0f4-4809-9424-46b7e45e76c9.jpg", alt: "Муса Җәлил һәм Н.Җиһанов «Алтынчәч» операсы өстендә эшләгәндә", caption: "Н.Җиһанов белән. «Алтынчәч» операсы өстендә эшләү чагы" },
  ...
  { src: "https://cdn.poehali.dev/files/6be6b3eb-9cbb-4641-9215-e00813994a7a.jpg", alt: "«Алтынчәч» операсыннан күренеш", caption: "«Алтынчәч» операсыннан күренеш (Татар дәүләт опера һәм балет театры)" },
  { src: "https://cdn.poehali.dev/files/0ab7ebad-7c5b-485d-9e2c-bc5224b0a2b6.jpg", alt: "Галия Кайбицкая «Алтынчәч» партиясендә", caption: "«Алтынчәч» партиясен беренче булып башкаручы Галия Кайбицкая татар опера һәм балет театры сәхнәсендә." },
  { src: "https://cdn.poehali.dev/files/326a7c28-cf77-487f-a5b9-c27a70a5520d.jpg", alt: "«Моңлы бер җыр» драмасы", caption: "Туфан Миңнуллинның «Моңлы бер җыр» драмасы. Спектакльдән өзекләр. (Г. Камал исемендәге Татар дәүләт академия театры; режиссеры М. Сәлимҗанов)" },
  { src: "https://cdn.poehali.dev/files/ab36f7d9-2e1b-4847-9b6c-6ed820e9dcbb.jpg", alt: "«Моңлы бер җыр» драмасы", caption: "Туфан Миңнуллинның «Моңлы бер җыр» драмасы. Спектакльдән өзекләр. (Г. Камал исемендәге Татар дәүләт академия театры; режиссеры М. Сәлимҗанов)" },
];
