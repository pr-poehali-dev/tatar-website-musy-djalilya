...
const photos = [
  ...
  { src: "https://cdn.poehali.dev/files/0ab7ebad-7c5b-485d-9e2c-bc5224b0a2b6.jpg", alt: "Галия Кайбицкая «Алтынчәч» партиясендә", caption: "«Алтынчәч» партиясен беренче башкаручысы, татар опера һәм балет театры сәхнәсендә Галия Кайбицкая." },
