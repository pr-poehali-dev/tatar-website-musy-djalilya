    ...
    <div className="min-h-screen bg-white text-[#1a1a1a]" style={{ fontFamily: "'Golos Text', sans-serif" }}>
      ...
      <main className="px-8 md:px-16 lg:px-24 pb-24">
        <div className="w-full">
          ...
          <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-5 text-justify">
            Шунысы да мөһим: əлеге Мирасханəдə Җəлилнең əдəби мирасы туплану шагыйрь иҗатын өйрəнүгə көчле этəргеч булып торган. Архив фондында шагыйрьнең төрле елларда язылган əсəрлəре, шигырь караламалары, күпсанлы мəкалəлəре, дистəлəрчə хатлары, опера театры оештыру буенча алып барган эш документлары һ.б. саклана.<sup className="text-[#aaa] text-[12px] ml-0.5">[1]</sup>
          </p>
          <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-5 text-justify">
          ...
          <div className="mt-16 pt-10 border-t border-[#e5e5e5]">
            ...
            <ol className="space-y-2 list-none pl-0">
              {[
                "ТР ФА ТӘСИ Язма мирас үзəге (Мирасханə). Муса Җəлил шəхси фонды, 10 нчы фонд.",
                "Муса Җəлилнең Сталинга хаты. 1939 ел. // ТР ФА ТӘСИ Мирасханə, ф. 10, оп. 1.",
                "Сəйфуллина Г. Муса Мостафа улы Җəлилов. — Казан: ТКИ, 1986.",
              ].map((item, i) => (
