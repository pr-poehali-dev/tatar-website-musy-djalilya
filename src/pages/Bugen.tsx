    ...
    <div className="min-h-screen bg-white text-[#1a1a1a]" style={{ fontFamily: "'Golos Text', sans-serif" }}>
      ...
      <main className="px-8 md:px-16 lg:px-24 pb-24">
        <div className="w-full">
          ...
          <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-5 text-justify">
            Муса Җəлил исеме бүген дə яши — монументларда, музейларда, мəктəплəрдə.
          </p>
          <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-5 text-justify">
          ...
          <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-8 text-justify">
            Әмма бүген Җәлил исеме монументларда, музейларда гына түгел, ә заманча сәнгатьтә дә яңа сулыш ала. Шагыйрьнең үлемсез юлларын бүгенге көндә яңача аңлату, аны кино теле, музыка, драматик уку аша тамашачыга җиткерү — заманның үзеннән килгән ихтыяҗ. Шуңа күрә бүген безнең өчен аеруча мөһим: талантлы артист Ришат Әхмадуллин Муса Җәлилнең "Җырларым" шигыренә экранизация ясаган. Бу — фашист әсирлегендә язылган соңгы дәфтәрләрнең беренче шигыре, анда шагыйрь үлем алдыннан да сүзенә, халкына, намусына тугры булып кала. Ришат Әхмадуллин башкаруында Җәлил юллары бүгенге тамашачыга якын, ачык һәм шул ук вакытта шаккатыргыч дәрәҗәдә көчле иңдерелә.
          </p>
          ...
          <div className="w-full mb-10" style={{ position: "relative", paddingBottom: "56.25%", height: 0, overflow: "hidden" }}>
            <iframe
              ...
              title="Ришат Әхмадуллин — Җырларым"
