      ...
      <main className="px-8 md:px-16 lg:px-24 pb-24">
        <div className="w-full">
          ...
          <div className="mb-10 w-full">
            ...
            <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-4 text-justify">
              Сугышка кадәрге еллар аның иҗат ягыннан иң бай чоры булды. «Алтынчәч» операсының либреттосы, «Илдар» операсы, «Җирән чәч» балеты — болар барысы да шул елларда туды.<sup className="text-[#aaa] text-[12px] ml-0.5">[1]</sup>
            </p>
          ...
          <div className="mb-10 w-full">
            ...
            <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-4 text-justify">
              Җәлилне опера студиясендә эшләү шулкадәр мавыктыра ки, 1939 елда, студиялеләр укуларын тәмамлап, Казанга күченгәч, ул алар белән бергә китә. Параллель рәвештә иҗтимагый эш белән дә шөгыльләнде — 1939 елдан 1941 елга кадәр Татарстан АССР Язучылар берлегенең җаваплы сәркатибе вазифасын башкарды.<sup className="text-[#aaa] text-[12px] ml-0.5">[2]</sup>
            </p>
          </div>
          ...
          <div className="mt-16 pt-10 border-t border-[#e5e5e5]">
            ...
            <ol className="space-y-2 list-none pl-0">
              {[
                "Сəйфуллина Г. Муса Мостафа улы Җəлилов тормышы həм иҗаты. — Казан: ТКИ, 1986.",
                "Татарстан АССР Язучылар берлеге документлары. — Казан, 1939–1941. // ТР МА, ф. 6829.",
                "Кашшаф Г. Муса Җәлил турында истәлекләр // «Казан утлары», 1966, № 2.",
              ].map((item, i) => (
