        ...
        <div className="w-full">
          ...
          <div className="mb-10 w-full">
            ...
            <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-4 text-justify">
              Җәлил һәрвакыт Мәскәү дуслары даирәсендә була. «Татар москвичлары» — Мәхмүд Максуд, Әхмәт Фәйзи, Латыйф Хәмиди, студиячеләр киләләр, казанлылар — Гази Кашшаф, Хәсән Туфан, Әхмәт Исхак, Сибгат Хәким киләләр, башкалар да, кыскасы, бөтен татар әдәбиятчылары диярлек килеп карыйлар.
            </p>
            <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-4 text-justify">
          ...
          <div className="mb-10 w-full">
            ...
            <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-4 text-justify">
              Иҗади мохиттә яшь Муса Җәлил яшьтәшләре белән тыгыз аралашты. «Октябрь баласы» журналы тирәсендә тупланган шагыйрьләр, язучылар, композиторлар — алар яңа татар мәдәниятен бергәләп формалаштырдылар.
            </p>
            <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-4 text-justify">
          ...
          <div className="mb-10 w-full">
            <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-4 text-justify">
              Хатыны Әминә белән уртак тормыш, кызы Чулпанның тууы шагыйрьнең лирик юлларында үзенчәлекле эз калдырды. Сугышка кадәрге еллар аның иҗат ягыннан иң бай чоры булды.
            </p>
            <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-4 text-justify">
