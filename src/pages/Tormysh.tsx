      ...
      <main className="px-8 md:px-16 lg:px-24 pb-24">
        <div className="w-full">
          ...
          <div className="mb-12 w-full">
            ...
            <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-5 text-justify">
              1914 елда əдип шəкерт булып, «Хөсəениягə» укырга керə. Нəкъ шул ук елны ул беренче тапкыр əдəби əсəрлəр укый: Габдулла Тукай шигырьлəре һəм А.С.Пушкинның əкиятлəре. Муса еш кына «Белек» китапханəсенə йөри торган була. Анда ул танылган язучы Шариф Камал белəн таныша.<sup className="text-[#aaa] text-[12px] ml-0.5">[1]</sup>
            </p>
            <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-5 text-justify">
          ...
          <div className="mb-12 w-full">
            ...
            <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-5 text-justify">
              Ул шигырь язып, аны Ченекəйгə китерə. Шактый соңрак, егерменче гасырның җитмешенче елларында, Ырынбур төбəкне өйрəнүче Ибəтулла Таңалин Җəлилнең 1918 елның 15 октябрендə язылган шигырен таба. Ул безгə килеп җиткəн шигырьлəрнең беренчесе булып санала həм «кечкенə Җəлил» дип имзалана.<sup className="text-[#aaa] text-[12px] ml-0.5">[2]</sup>
            </p>
            <div className="clear-both" />
          </div>
          ...
          <div className="mb-12 w-full">
            ...
            <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-5 text-justify">
              1929 елда университетны тəмамлагач, Муса Казанга кайта həм анда əдəби эшчəнлеген дəвам итə. Ул газеталарда, журналларда эшли, татар əдəбиятының үсешенə зур өлеш кертə.<sup className="text-[#aaa] text-[12px] ml-0.5">[3]</sup>
            </p>
            <div className="clear-both" />
          </div>
          ...
          <div className="mb-12 w-full">
            ...
            <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-5 text-justify">
              1956 елның 2 февралендә СССР Верховный Советы Президиумы Указы белән Муса Җәлилгә Ватан сугышы чорында күрсәткән тиңдәшсез ныклыгы һәм батырлыгы өчен Советлар Союзы Герое исеме бирелде, ә әсирлектә тудырган поэтик иҗаты — бөтен дөньяга мәшһүр «Моабит дәфтәрләре» Ленин премиясенә лаек булды.<sup className="text-[#aaa] text-[12px] ml-0.5">[4]</sup>
            </p>
            <p className="font-body text-[16px] md:text-[17px] leading-[1.85] text-[#333] mb-5 text-justify">
          ...
          <div className="mt-16 pt-10 border-t border-[#e5e5e5]">
            ...
            <ol className="space-y-2 list-none pl-0">
              {[
                "Сəйфуллина Г. Муса Җəлил тормышы həм иҗаты. — Казан: ТКИ, 1986.",
                "Таңалин И. Кечкенə Җəлил шигырьлəре. — Ырынбур, 1972.",
                "Рафиков Р. Муса Җəлил биографиясе. — Казан: Татарстан китап нəшрияты, 1979.",
                "СССР Верховный Советы Президиумы Указы. 1956 ел, 2 февраль. — Мəскəү, 1956.",
              ].map((item, i) => (
