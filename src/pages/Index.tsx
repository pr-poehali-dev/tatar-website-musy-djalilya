...
const sectionPreviews = [
  ...
  },
  {
    ...
    path: "/bugen",
    text: "Муса Җəлил исеме бүген дə яши — монументларда, музейларда, мəктəплəрдə. 1966 елда Кремль янында Муса Җəлилгə həйкəл ачыла (скульптор В.Е.Цигаль). Казан Кремлендə Муса Җəлил музее эшли. Аның əсəрлəре дөньяның йөздəн артык теленə тəрҗемə ителгəн. Ел саен Татарстанда шагыйрьнең туган көнен — 15 февральне — олы бəйрəм итеп үткəрəлəр.",
    imgSrc: "https://cdn.poehali.dev/files/c0dc499f-1408-45cc-b2c9-2f062230ba22.jpg",
    imgAlt: "Муса Җәлил",
    imgCaption: "",
    imgRight: true,
